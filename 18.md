...
> 原文：[Annotating Last Price Stock Chart with Matplotlib](https://pythonprogramming.net/last-price-stock-chart-matplotlib-tutorial/?completed=/annotations-text-matplotlib-tutorial/)
