...
> 原文：[Implementing Subplots to our Chart with Matplotlib](https://pythonprogramming.net/implementing-subplots-matplotlib-tutorial/?completed=/subplot2grid-add_subplot-matplotlib-tutorial/)
