...
> 原文：[Custom fills, pruning, and cleaning with Matplotlib](https://pythonprogramming.net/more-indicator-data-matplotlib-tutorial/?completed=/implementing-subplots-matplotlib-tutorial/)
...
所以，这里发生的是，我们通过首先将`nbins`设置为5来修改我们的`y`轴对象。这意味着大多数我们将显示的标签是 5。然后我们还可以『修剪』标签，因此，在我们这里， 我们修剪底部标签，这会使它消失，所以现在不会有任何文本重叠。 我们仍然可能打算修剪`ax2`的顶部标签，但这里是我们目前为止的源代码：
